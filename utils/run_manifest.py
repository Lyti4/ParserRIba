    ...
    *,
    ...
    return RunManifest(
        ...
        summary={
            ...
            "full_catalog_count": int(result.diagnostics_summary.get("full_catalog_count") or 0),
            "full_catalog_tree": list(result.diagnostics_summary.get("full_catalog_tree") or []),
            "full_catalog_links": list(result.diagnostics_summary.get("full_catalog_links") or []),
