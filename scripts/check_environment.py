...
from utils.proxy import load_proxy_config_from_env, mask_proxy_url, parse_proxy_url
...
def main() -> int:
    ...
    elif not proxy_config.enabled:
        logger.info("Proxy disabled by PARSER_PROXY_ENABLED")
    else:
